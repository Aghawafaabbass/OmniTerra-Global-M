...
║    Framework for Global Yield Intelligence & Carbon Modeling         ║
╚══════════════════════════════════════════════════════════════════════╝
```
...
[![Preprint](https://img.shields.io/badge/Preprint-10.5281%2Fzenodo.20308398-blue?style=for-the-badge&logo=zenodo)](https://doi.org/10.5281/zenodo.20308398)
[![Software](https://img.shields.io/badge/Software_v1.0-10.5281%2Fzenodo.20308741-green?style=for-the-badge&logo=zenodo)](https://doi.org/10.5281/zenodo.20308741)
...
**Production-deployed AI framework combining live Sentinel-2 satellite data, Spatio-Temporal Transformers, and IPCC-aligned carbon sequestration modeling for global precision agriculture.**
...
| Type | Reference |
|---|---|
| 📘 **Preprint** | Abbas, A. W. (2026). *OmniTerra: A Multi-Modal Spatio-Temporal Transformer Framework for Global Yield Intelligence and Carbon Sequestration Modeling.* Zenodo. [https://doi.org/10.5281/zenodo.20308398](https://doi.org/10.5281/zenodo.20308398) |
| 💾 **Software v1.0** | Agha Wafa Abbas. (2026). *OmniTerra v1.0.0 — Production Release.* Zenodo. [https://doi.org/10.5281/zenodo.20308741](https://doi.org/10.5281/zenodo.20308741) |
...
│  Data Acq.      │  Inference Engine    │    Deployment Layer         │
├─────────────────┼──────────────────────┼─────────────────────────────┤
...
│   (B8−B4)/      │ • ŷ  (t/ha)         │ • Downloadable Reports      │
│   (B8+B4)       │ • C_ag (Mg C/ha)    │                             │
└─────────────────┴──────────────────────┴─────────────────────────────┘
                       x = [NDVI, T, SM] ∈ ℝ³
```
...
class OmniTerraTransformer(torch.nn.Module):
    def __init__(self, input_dim=3, model_dim=64):
        ...
        self.attention = torch.nn.MultiheadAttention(
                             model_dim, num_heads=4,
                             batch_first=True)                     # 4-head MHSA
...
| Fig. 4 — Live Inference | Fig. 5 — Multi-Modal Insights |
|:---:|:---:|
| ![Wheat USA Part 1](https://github.com/Aghawafaabbass/OmniTerra-Global-M/blob/main/Screenshots/Wheat%20(USA%20-%20High%20Greenery)%20Part%201.PNG?raw=true) | ![Wheat USA Part 2](https://github.com/Aghawafaabbass/OmniTerra-Global-M/blob/main/Screenshots/Wheat%20(USA%20-%20High%20Greenery)%20Part%202.PNG?raw=true) |
| *NDVI: 0.34 · Yield: 3.57 t/ha* | *Carbon: 1.68 Mg C/ha · Status: Normal Growth* |

> Active photosynthetic growth detected. Transformer predicted **3.57 t/ha**. Vegetation status: **Stable**. Inference confidence: **94.2%**.
...
| Fig. 8 — Live Inference | Fig. 9 — Multi-Modal Insights |
|:---:|:---:|
| ![Wheat Ukraine Part 1](https://github.com/Aghawafaabbass/OmniTerra-Global-M/blob/main/Screenshots/Wheat%20(Ukraine%20-%20Low%20Greenery)%20Part%201.PNG?raw=true) | ![Wheat Ukraine Part 2](https://github.com/Aghawafaabbass/OmniTerra-Global-M/blob/main/Screenshots/Wheat%20(Ukraine%20-%20Low%20Greenery)%20Part%202.PNG?raw=true) |
| *NDVI: 0.13 · Yield: 3.10 t/ha* | *Carbon: 1.46 Mg C/ha · Status: Critical Monitoring* |

> Sparse vegetation detected (NDVI = **0.13**). Model adjusted yield to **3.10 t/ha**. Precision Insights: **Low Vegetation Density** → Nitrogen-based soil enrichment recommended.
...
| Fig. 6 — Live Inference | Fig. 7 — Multi-Modal Insights |
|:---:|:---:|
| ![Rice China Part 1](https://github.com/Aghawafaabbass/OmniTerra-Global-M/blob/main/Screenshots/Rice%20(China%20-%20Water%20and%20Bare%20Soil%20Area)%20Part%201.PNG?raw=true) | ![Rice China Part 2](https://github.com/Aghawafaabbass/OmniTerra-Global-M/blob/main/Screenshots/Rice%20(China%20-%20Water%20and%20Bare%20Soil%20Area)%20Part%202.PNG?raw=true) |
| *NDVI: 0.05 · Yield: 0.89 t/ha (bare soil/water)* | *Carbon: 0.42 Mg C/ha · Status: Critical Monitoring* |

> NDVI **0.05** indicates water logging or bare soil. Transformer reduced yield to **0.89 t/ha** — demonstrating robust edge-case handling. Carbon: **0.42 Mg C/ha**.
...
| Fig. 10 — Live Inference | Fig. 11 — Multi-Modal Insights |
|:---:|:---:|
| ![Maize Brazil Part 1](https://github.com/Aghawafaabbass/OmniTerra-Global-M/blob/main/Screenshots/Maize%20(Brazil%20-%20Ultra%20High%20Greenery)%20Part%201.PNG?raw=true) | ![Maize Brazil Part 2](https://github.com/Aghawafaabbass/OmniTerra-Global-M/blob/main/Screenshots/Maize%20(Brazil%20-%20Ultra%20High%20Greenery)%20Part%202.PNG?raw=true) |
| *NDVI: 0.66 · Yield: 7.41 t/ha (peak greenery)* | *Carbon: 3.48 Mg C/ha · Status: High Photosynthetic Activity* |

> Exceptionally high NDVI of **0.66**. Framework projected outstanding yield of **7.41 t/ha**. Status: **High Photosynthetic Activity** — Maintain current nutrient levels. Vegetation: **Optimal**.
...
| Fig. 12 — Live Inference | Fig. 13 — Multi-Modal Insights |
|:---:|:---:|
| ![Maize Kenya Part 1](https://github.com/Aghawafaabbass/OmniTerra-Global-M/blob/main/Screenshots/Maize%20(Kenya%20-%20Moderate%20Fields)%20Part%201.PNG?raw=true) | ![Maize Kenya Part 2](https://github.com/Aghawafaabbass/OmniTerra-Global-M/blob/main/Screenshots/Maize%20(Kenya%20-%20Moderate%20Fields)%20Part%202.PNG?raw=true) |
| *NDVI: 0.52 · Yield: 6.54 t/ha* | *Carbon: 3.08 Mg C/ha · Status: Normal Growth Cycle* |

> Balanced NDVI **0.52** → reliable forecast of **6.54 t/ha**. Status: **Normal Growth Cycle** → Regular monitoring recommended. Vegetation: **Optimal**. Inference confidence: **94.2%**.
...
earthengine authenticate        # local development only
```
...
1. Enter **Latitude & Longitude** for your field
2. Select **Crop** — Wheat / Rice / Maize
3. Click **Run Live Inference**
4. Review: Yield (t/ha) · NDVI · Carbon (Mg C/ha) · Health Status · Recommendations
...
features = get_live_features(31.5204, 74.3587, "Wheat")   # Lahore, Pakistan
with torch.no_grad():
    pred = model(torch.tensor([features], dtype=torch.float32)).item()

print(f"Yield : {pred:.2f} t/ha")
print(f"Carbon: {pred * 0.47:.2f} Mg C/ha")
```
...
| Model Checkpoint | ~98 KB (`omni_terra_v1.pth`) |
...
**OmniTerra is the only production-deployed framework combining real-time EO integration, Transformer-based inference, and IPCC-aligned carbon estimation.**
...
📧 Commercial inquiries: [agha.wafa@port.ac.uk](mailto:agha.wafa@port.ac.uk)
...
>
> Satellite data accuracy depends on Sentinel-2 availability and cloud cover. Carbon estimates are indicative only — not suitable for carbon credit verification or NDC reporting without field-level validation. Software provided "AS IS" without warranty of any kind.
>
